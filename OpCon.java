public class OpCon extends Component {

    public OpCon(CanvasPanel canvas, String id) {
        super(canvas, id);
        node = false;
        removable = true;
        rateVal = false;
    ...
    public void paintComponent(Graphics g) {
        ...
        g2d.drawLine(30, 78, 70, 78);
        g2d.drawLine(68, 75, 70, 78);
        g2d.drawLine(68, 81, 70, 78);
        g2d.setStroke(new BasicStroke(1));

        //draw component name
        g2d.setColor(Color.black);
        if (cp.compValue) {
            drawCenteredString("CON", 100, 100, g2d);
        } else {
